  ...
  <body>
	...
	<div class="panel panel-info">
		...
		?>
			...
			<input type="hidden" class="form-control input-sm" name="moneda" id="moneda" readonly value="<?php echo $moneda;?>">
				  ...
				  <label for="tel1" class="col-md-1 control-label">Teléfono</label>
					...
					<label for="mail" class="col-md-1 control-label">Email</label>
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<input type="text" class="form-control input-sm" name="fecha" id="fecha" value="<?php echo $fecha_factura;?>">
							</div>
