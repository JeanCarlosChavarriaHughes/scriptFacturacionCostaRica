...
include('is_logged.php');//Archivo verifica que el usario que intenta acceder a la URL esta logueado
	...
	if (empty($_POST['codigo'])) {
		...
		$sql="INSERT INTO products (codigo_producto, nombre_producto, status_producto, date_added, precio_producto,precio_colon) VALUES ('$codigo','$nombre','$estado','$date_added','$precio_venta','$precio_colon')";
