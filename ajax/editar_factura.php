<?php
	...
	if (empty($_POST['id_cliente'])) {
           ...
           $errors[] = "Selecciona el vendedor";
			...
			$errors[] = "Verifique el valor de la fecha de acuerdo al formato mes-dia-año: ".$_POST['fecha'];
		} else if (
		...
		$sql="UPDATE facturas SET id_cliente='".$id_cliente."', fecha_factura='".$fecha."', id_vendedor='".$id_vendedor."', condiciones='".$condiciones."', estado_factura='".$estado_factura."' WHERE id_factura='".$id_factura."'";
